<template>
  <div>
    <Renderer ref="renderer" antialias alpha shadow mouse-move resize="window" :orbit-ctrl="{ enableDamping: true }"
      @mousemove="onMouseMove">
      <Camera :position="{ z: 400 }" />
      <Scene>
        <AmbientLight color="#808080" />
        <Group ref="lightGroup">
          <DirectionalLight ref="light" :intensity="1" :position="{ x: 0, y: 300, z: 0 }" cast-shadow
            :shadow-camera="{ top: 120, bottom: -120, left: -120, right: 120 }" />
        </Group>
...
import LittlePlanet from './littlePlanet/LittlePlanet.vue';
