<template>
  <PlanetGroup ref="group">
    <Globe ref="globe" :duration="2000" :delay="1000" :radius="radius" :detail="detail" :noise-conf="noiseConf"
...
import { BasicMaterial, Icosahedron } from 'troisjs';
...
export default {
  name: 'LittlePlanet',
  // extends: Object3D,
  components: { PlanetGroup, Globe, Tree, Rock, Icosahedron, BasicMaterial },
